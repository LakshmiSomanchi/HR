...
- Create a GitHub repo: `pmu-user-management`
- Push the whole folder including:
  - `pmu_user_mgmt/`
  - `streamlit_app/`
  - `requirements.txt`
- Deploy Streamlit: [streamlit.io/cloud](https://streamlit.io/cloud)

---

This version is now **exclusively for HR** with restricted email login, onboarding/interview automation, and PDF download of interview reports.
